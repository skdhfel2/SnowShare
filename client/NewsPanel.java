...
public class NewsPanel extends JPanel {
  ...
  private NewsItem currentSelectedNews;
  ...
  private void initializeComponents() {
    ...
    newsList.addListSelectionListener(e -> {
      if (!e.getValueIsAdjusting()) {
        NewsItem selected = newsList.getSelectedValue();
        if (selected != null) {
  ...
  private void loadNews() {
    ...
    new Thread(() -> {
      try {
        java.util.List<NewsItem> newsItems = newsService.fetchNews("폭설");
  ...
  private void updateNewsDetail(NewsItem news) {
    updateNewsDetail(news, null);
  }
  
  private void updateNewsDetail(NewsItem news, String aiSummary) {
